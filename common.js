var fs = require('fs');
var sites = [
  {static: 'static/quanben', targetUrl: 'https://www.quanben.net', formatHtml: './public/format/quanben.js', source: ['localhost:8183', 'sexs8.com', 'www.sexs8.com']},
  {static: 'static/quanben_m', targetUrl: 'https://m.quanben.net', formatHtml: './public/format/quanben.js', source: ['localhost:8082','m.sexs8.com']},
